...
|===
|Services\Client | Hexagon | Helyx | OpenSphere | Esri | Solenix | EURAC | Sinergise | [GeoPackage/MapCache](http://ngageoint.github.io/GeoPackage/)
...
|[MAGE](https://github.com/ngageoint/mage-server/tree/wfs3) | | | | | | | | Features
